...
* on Github in ServerConfiguration is a folder called "breakingpoint_server_config" download it to your server
* edit the config.cpp in there to your server likings
