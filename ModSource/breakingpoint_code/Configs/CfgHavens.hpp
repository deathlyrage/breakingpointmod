...
class House_F: House
{
	...
	cost=50000;
	armor=5000;
	replaceDamagedLimit=0.99989998;
	class DestructionEffects: DestructionEffects
	{
	};
};
class House_Small_F: House_F
{
	...
	class DestructionEffects: DestructionEffects
	{
		...
		class Smoke1Med: Smoke1Med
		{
			type="HouseDestructionSmoke3Small";
		};
		class Smoke2Med: Smoke2Med
		{
			type="HouseDestructionSmoke4Small";
		};
		class Smoke3Med: Smoke3Med
		{
			type="HouseDestrSmokeLongSmall";
		};
		class Smoke1Low: Smoke1Low
		{
			type="HouseDestructionSmoke3Small";
		};
		class Smoke2Low: Smoke2Low
		{
			type="HouseDestructionSmoke4Small";
		};
		class Smoke3Low: Smoke3Low
		{
			type="HouseDestrSmokeLongSmall";
		};
	};
...
class Land_Shed_Ind02: House_F
{
	...
	class UserActions
	{
		class OpenDoors
		{
			...
			radius=3;
			onlyForPlayer=0;
			condition="((this animationPhase 'dvere1L') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		class OpenDoors2
		{
			...
			radius=2;
			onlyForPlayer=0;
			condition="((this animationPhase 'dvere2L') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
...
class Land_i_Shed_Ind_F: House_F
{
	...
	class UserActions
	{
		...
		class OpenDoor_2
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_2_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_2_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_3
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_3_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_3_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_4
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_4_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_4_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_5
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_5_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_5_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_6
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_6_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_6_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_7
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_7_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_7_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
		...
		class OpenDoor_8
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_8_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_8_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1)";
...
class Land_i_House_Big_02_V1_F: House_F
{
	...
	class UserActions
	{
		...
		class OpenDoor_6
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_6_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1) && ((this animationPhase 'Hitzone_2_hide') < 0.99999				)";
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_6_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1) && ((this animationPhase 'Hitzone_2_hide') < 0.99999				)";
...
class Land_i_Stone_HouseSmall_V1_F: House_F
{
	...
	class UserActions
	{
		...
		class OpenDoor_2
		{
			...
			radius=1.5;
			onlyForPlayer=1;
			condition="((this animationPhase 'Door_2_rot') < 0.5) && ((this getVariable ['bis_disabled_Door_1',0]) != 1) && ((this animationPhase 'Hitzone_2_hide') < 0.99999				)";
			statement="([this, 'Door_2_rot'] call BIS_fnc_DoorNoHandleOpen)";
		};
		class CloseDoor_2: OpenDoor_2
		{
		...
		{
			displayNameDefault="<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			condition="((this animationPhase 'Door_2_rot') < 0.1) && ((this getVariable ['bis_disabled_Door_1',0]) == 1) && ((this animationPhase 'Hitzone_2_hide') < 0.99999				)";
			statement="([this, 'Door_Locked_2_rot'] spawn BIS_fnc_LockedDoorNoHandleOpen)";
		};
		class OpenDoor_3
		{
