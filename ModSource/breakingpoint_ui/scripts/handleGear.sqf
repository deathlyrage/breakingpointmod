...
_icons = [
 "\A3\ui_f\data\igui_buyUnit_filter_1_ca.paa",
 "\A3\ui_f\igui_buyUnit_filter_2_ca.paa",
 "\A3\ui_f\igui_buyUnit_filter_3_ca.paa",
 "\A3\ui_f\data\igui_buyUnit_filter_4_ca.paa",
 "\A3\ui_f\data\igui_buyUnit_filter_5_ca.paa"
];
