		...
		class BasicGroup: RscControlsGroup
		{
			...
			class controls
			{
				...
				class TextLighting: RscText
				{
					style=0;
					idc=1050;
					text="$STR_A3_RscDisplayOptionsVideo_TextLighting";
				...
				{
					idc=1049;
					text="$STR_A3_RscDisplayOptionsVideo_TextWaterReflections";
					x="19.7 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					y="13 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					w="9.8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
				...
				class ValueWaterReflections: RscCombo
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RscDisplayOptionsVideo_ValueWaterReflections_tooltip";
				};
		...
		class RenderingGroup: RscControlsGroup
		{
			...
			class controls
			{
				...
				class ValueBloom: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUEBLOOM_TOOLTIP";
				};
				...
				class ValueRadialBlur: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUERADIALBLUR_TOOLTIP";
				};
				...
				class ValueRotationBlur: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUEROTATIONBLUR_TOOLTIP";
				};
				...
				class ValueDOF: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUEDOF_TOOLTIP";
				};
				...
				{
					idc=1048;
					text="$STR_A3_RscDisplayOptionsVideo_TextSharpenFilter";
					x="0 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
				...
				class ValueSharpenFilter: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUESHARPENFILTER_TOOLTIP";
				};
				...
				class TextPPColorCorrections: RscText
				{
					style=0;
					idc=1055;
					text="$STR_A3_RscDisplayOptionsVideo_TextPPColorCorrections";
					x="19.8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					y="0 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					w="18.2 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
				...
				{
					idc=1051;
					text="$STR_A3_RSCDISPLAYOPTIONSVIDEO_TEXTCOLORPRESET";
				...
				class ValueImageAdjustments: RscCombo
				{
					...
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_VALUECOLORPRESET_TOOLTIP";
				};
				...
				class SliderBrightnessPP: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RSCDISPLAYOPTIONSVIDEO_SLIDERBRIGHTNESSPP_TOOLTIP";
				};
				...
				class SliderContrast: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RscDisplayOptionsVideo_SliderContrast_tooltip";
				};
				...
				class SliderSaturation: RscXSliderH
				{
					...
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_A3_RscDisplayOptionsVideo_SliderSaturation_tooltip";
				};
