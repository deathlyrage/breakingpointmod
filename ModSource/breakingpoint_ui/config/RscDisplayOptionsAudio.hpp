	...
	class controls
	{
		...
		{							   
			...
			class controls
			{
				...
				class CA_TextMapVolume: RscText
				{
					style=1;
					idc=1009;
					text="$STR_DISP_MAPFACTOR";
					x="0 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					y="7.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					w="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
				};
				class CA_SliderMapVolume: RscXSliderH
				{
					idc=120;
					x="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					y="7.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					...
					tooltip="$STR_AUDIO_TOOLTIP_MAPFACTOR";
				};
	
				class CA_TextOutputDevice: RscText
				{
					style=1;
					idc=1007;
				...
				class CA_ComboOutputDevice: RscCombo
				{
					idc=116;
					x="8 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
					y="9 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					...
					tooltip="$STR_AUDIO_TOOLTIP_OUTPUT_DEVICE";
				};
	
				class CA_RefreshOutputDevice: RscButtonMenu
				{
					idc=115;
					...
					h="1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					tooltip="$STR_AUDIO_TOOLTIP_OUTPUT_REFRESH";
				};
