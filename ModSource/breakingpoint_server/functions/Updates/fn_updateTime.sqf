...
if (BP_Weather_Current == BP_Weather_None) then 
{
	...
	[] spawn
	{
		...
		[
			//Clear and Sunny
			["Clear",[0.30,0,0,0.01,0,0]],
			["Clear",[0.30,0,0,0,0,0]],
			["Clear",[0.30,0,0,0,0,0]],
			["Clear",[0.30,0,0,0,0.01,0]],
			["Clear",[0.30,0,0,0,0,0]],
			["Clear",[0.30,0,0,0,0,0]],
			["Clear",[0.30,0,0,0.01,0,0]],
			["Clear",[0.30,0,0,0,0,0]],
			...
			["Clear",[0.30,0,0,0,0.01,0]],
			["Clear",[0.30,0,0,0,0,0]],
			["Clear",[0.31,0,0,0,0,0]],
			["Clear",[0.32,0,0,0,0,0]],
			["Clear",[0.33,0,0,0,0,0]],
			["Clear",[0.34,0,0,0.01,0,0]],
			["Clear",[0.35,0,0,0,0,0]],
			["Clear",[0.36,0,0,0,0,0]],
			["Clear",[0.37,0,0,0,0,0]],
			["Clear",[0.38,0,0,0,0.01,0]],
			["Clear",[0.39,0,0,0,0,0]],
			["Clear",[0.40,0,0,0,0,0]],
			["Clear",[0.41,0,0,0,0,0]],
			["Clear",[0.42,0,0,0.03,0.02,0]],
			...
			["Rainstorm",[1,1,0,0.02,0.02,1]],		
			["Rainstorm",[0.544,0.422,0,0,0,0]],
			["Rainstorm",[0.632,0.422,0,0,0,0]],
			["Rainstorm",[0.544,0.3,0,0,0,0]],
			
			//Rainy
			["Overcast",[0.80,0,0,0.009,0.01,0.2]],
			["Light Rain",[0.50,0.3,0.05,0,0,0]],
			["Medium Rain",[0.60,0.2,0.05,0,0,0]],
			["Medium Rain",[0.65,0.0344,0,0,0,0]],
			["Medium Rain",[0.657,0.0530,0,0.01,0.01,0]],
			["Medium Rain",[0.657,0.1800,0,0,0,0]],
			["Medium Rain",[0.668,0.3230,0,0.02,0.02,0]],
			["Medium Rain",[0.672,0.5130,0,0,0,0]],
			
			//Foggy
			["Light Fog",[0.5,0,0.2,0.01,0.08,0]],
			["Medium Fog",[0.6,0,0.3,0.005,0.5,0]],
			["Dense Fog",[0.7,0.3,0.35,0.0025,0.6,0]]
		];
