...
if (BP_Weather_Current == BP_Weather_None) then 
{
	...
	[] spawn
	{
		...
		[
			...
			["Light Rain",[0.60,0.3,0.05,0,0,0]],
			["Medium Rain",[0.70,0.5,0.05,0,0,0]],
			...
			//Foggy
			["Light Fog",[0.4,0,0.2,0.01,0.08,0]],
			["Medium Fog",[0.4,0,0.3,0.005,12,0]],
			["Dense Fog",[0.5,0,0.35,0.0025,15,0]]
		];
